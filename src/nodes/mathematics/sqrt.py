...
from src.node_editor.constants import NODE_MATHEMATICS_SQRT
...
@register_node(NODE_MATHEMATICS_SQRT) 
class InputINTNode(Node): 
    width = 400
    height = 80 
    op_code = NODE_MATHEMATICS_SQRT
    op_title = "Karekök İşlemi "
    ...
    def evalImplementation(self, name=None, data=None):
        ...
        if isinstance(a, (int, float)) :
            self.sendData("Sonuç", math.sqrt(a))
            self.content.edit.setText(str(math.sqrt(a)))
        else:
