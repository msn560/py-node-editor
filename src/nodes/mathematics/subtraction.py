...
from src.node_editor.constants import NODE_MATHEMATICS_SUBTRACTION  
...
@register_node(NODE_MATHEMATICS_SUBTRACTION) 
class InputINTNode(Node): 
    width = 400
    height = 80 
    op_code = NODE_MATHEMATICS_SUBTRACTION
    op_title = "Çıkartma İşlemi (A-B)"
