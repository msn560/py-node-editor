...
from src.node_editor.constants import NODE_MATHEMATICS_DIVISION   
...
@register_node(NODE_MATHEMATICS_DIVISION) 
class InputINTNode(Node): 
    width = 400
    height = 80 
    op_code = NODE_MATHEMATICS_DIVISION
    op_title = "Bölme İşlemi (A/B) (A%B)"
    content_label_objname = "line_int_division"
    ...
    def evalImplementation(self, name=None, data=None): 
        ...
        if isinstance(a, (int, float)) and isinstance(b, (int, float)):
            ...
            self.sendData("Kalan", a%b)
            self.content.edit.setText( str(a/b))
            self.content.edit2.setText(str( a%b))
        else:
