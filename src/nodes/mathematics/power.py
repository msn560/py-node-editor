...
from src.node_editor.constants import NODE_MATHEMATICS_POWER
...
@register_node(NODE_MATHEMATICS_POWER) 
class InputINTNode(Node): 
    width = 400
    height = 80 
    op_code = NODE_MATHEMATICS_POWER
    op_title = "Üs Alma İşlemi (A**B)"
    content_label_objname = "line_int_power"
