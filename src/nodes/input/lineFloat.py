...
from src.node_editor.constants import NODE_INPUT_FLOAT 
...
@register_node(NODE_INPUT_FLOAT) 
class InputINTNode(Node): 
    width = 400
    height = 80 
    op_code = NODE_INPUT_FLOAT
    op_title = "Rasyonel Sayı"
    content_label_objname = "line_float_text"
    ...
    def onInputTextChanged(self ):
        try:
            ...
            self.sendData("Çıkış",float(text))
        except :
            pass