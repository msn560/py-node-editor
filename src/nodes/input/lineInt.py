...
@register_node(NODE_INPUT_INT) 
class InputINTNode(Node): 
    width = 400
    height = 80 
    op_code = NODE_INPUT_INT
    op_title = "Tam Sayı"
    content_label_objname = "line_int_text"
